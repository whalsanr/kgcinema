...
<style>
    ...
    * {box-sizing: border-box;font-family: '나눔고딕','NanumGothic','맑은 고딕','Malgun Gothic','돋움',dotum,'Apple SD Gothic Neo',sans-serif;}
    ...
    #container{position: relative;margin-bottom: 85px;}
    ...
    .custom-pagination li a{display: block;padding: 0 8px;height: 25px;line-height: 25px;font-size: 12pt;color: #666;vertical-align: middle;
    ...
    .custom-pagination li a:hover{text-decoration: underline;}
</style>
